  ...
  return (
    <div className="content">
      ...
      <p>
        ...
        by human, and two by machines. All of the solutions are valid and mistake-free.
        Your task is to decide which two of the four solutions are written by human.
    ...
    <ul className="invisible-list">
      ...
      <li><input type="checkbox" value={q2} onChange={() => setQ2(!q2)} /><span>The exercises involves picking step-by-step solutions based on your belief in which one is written by human.</span></li>
      ...
      <li><input type="checkbox" value={q4} onChange={() => setQ4(!q4)} /><span>In "AABAC", swapping the order of the last two characters gives "AABCA"</span></li>
        ...
        <li><input type="checkbox" value={q6} onChange={() => setQ6(!q6)} /><span>There is no time limit for this experiment.</span></li>
